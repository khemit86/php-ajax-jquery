...
##### get all shift count of staff start ######
	...
	$pdf_html = '';
	$pdf_html  .= '<h1 style="text-align:center">Total Staff Hours Report ('.$_SESSION['login_department_name'].')</h1><table border="1" width="100%" cellpadding="20" cellspacing="0">
	<thead>
		<tr>
