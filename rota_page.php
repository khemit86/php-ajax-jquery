<?php include_once('include/header.php'); 
	...
	/* get sheft allocation record */
	
	$get_allocation_type_query = "SELECT allocation.allocation_id,allocation.allocation_details,allocation.allocation_type FROM allocation WHERE allocation.department_id = '".$_SESSION['login_department_id']."' ORDER BY allocation.allocation_type ASC ";
	...
	$get_shift_type_query = "SELECT shift_type.shift_type_id,shift_type.shift_type,shift_type.department_id FROM shift_type WHERE shift_type.department_id = '".$_SESSION['login_department_id']."' ORDER BY shift_type.shift_type_id ASC ";
	...
	$get_customer_query = "SELECT customer.customer_id,customer.first_name,customer.last_name FROM customer WHERE customer.department_id = '".$_SESSION['login_department_id']."' ORDER BY customer.customer_id ASC ";
...
?>	
	   ...
	   <div class="rota-page-sectn">
		<div class="table_rota_week1 responsive-table">
				<table border="0.5" width="100%" cellpadding="20" cellspacing="10">
					<tr>
						<th bgcolor="#183346" style="color:#FFFFFF" ><?php echo $_SESSION['login_department_name']; ?>
						</th>
						...
						<th bgcolor="#CCCCCC" style="color:#000000" >
						<ul class="week-list-sectn">
							<li>
								<a href="javascript:;"  data-attr-month="<?php echo $month_request; ?>" data-attr-year="<?php echo $year; ?>" data-attr-week = "0" class="week week-active">Week 1</a>
							</li>
							<li>
								<a href="javascript:;"  data-attr-month="<?php echo $month_request; ?>" data-attr-year="<?php echo $year; ?>" data-attr-week = "1" class="week">Week 2</a>
							</li>
							<li>
								<a href="javascript:;"  data-attr-month="<?php echo $month_request; ?>" data-attr-year="<?php echo $year; ?>" data-attr-week = "2" class="week">Week 3</a>
							</li>
							<li>
								<a href="javascript:;"  data-attr-month="<?php echo $month_request; ?>" data-attr-year="<?php echo $year; ?>" data-attr-week = "3" class="week">Week 4</a>
							</li>
						</ul>
						</th>
						<th bgcolor="#1e3647" style="color:#FFFFFF" ><a href="javascript:;" onclick="suggestionopen()" ><img src="images/icon/suggestion-icon.png">Send a Suggestion</a></th>
						<th bgcolor="#1958C9" style="color:#FFFFFF" ><a href="javascript:;" onclick="EmailStaff()" ><img src="images/icon/email-icon.png">Email ROTA to Staff</a></th>
						<th bgcolor="#1958C9" style="color:#FFFFFF" ><a href="javascript:;" onclick="manageopen()"><img src="images/icon/manage-department-icon.png">Manage Department ROTA Data</a></th>
						<th bgcolor="#EA5B50" style="color:#FFFFFF" id="weekly_hours_container">Total Weekly Hours : </th>
						<th bgcolor="#183346" style="color:#FFFFFF" ><a href="javascript:;" onclick="queryRota()" ><img src="images/icon/query-icon.png"> QUERY ROTA</a></th>
						<!--<th bgcolor="#006633" style="color:#FFFFFF" ><a href="javascript:;" data-popup-open="popup-3">UPDATE ROTA</a></th>-->
						<th bgcolor="#006633" style="color:#FFFFFF" ><a href="javascript:;" onclick="javascript:location.reload();"><img src="images/icon/plane-icon.png">PUBLISH ROTA</a></th>
				</table>
		</div>	
		...
		<table border="0.5" width="100%" cellpadding="5" cellspacing="5" id="fixTable">
		<thead>
				...
				<tr id="<?php echo $staff_obj->employee_number; ?>">
						...
						<td  style="padding:0;" id="<?php echo $staff_obj->employee_number."_".strtolower($day_key); ?>">
							<table width="100%" class="info-table <?php echo $rota_detail_table_class; ?>">
								<tbody>
									...
									<?php if(!empty($allocation_type)){ ?><tr class="shift_details"><td colspan="2">Core Shift Allocation:</td><td colspan="3"><?php echo $allocation_type; ?></td></tr> <?php } ?>
									<?php if(!empty($shift_details)){ ?> <tr class="shift_details"><td colspan="2">Shift Details: </td><td colspan="3"><?php echo $shift_details; ?></td></tr><?php } ?>
					...
					<div class="table-block-two">
						<table width="100%" class="total-hours info-table" cellpadding="0" cellspacing="0" >
							<tr>
								<td>Admin</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_admin_hours"?>" name="Admin" placeholder="<?php echo seconds_to_hoursminutes($admin_hours); ?>" class="input-type"></td>
							</tr>
							<tr>
								<td>Training</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_training_hours"?>" name="Training" placeholder="<?php echo seconds_to_hoursminutes($training_hours); ?>" class="input-type"></td>
							</tr>
							<tr>
								<td>Annual Leave</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_annual_leave_hours"?>" name="Toll" placeholder=<?php echo seconds_to_hoursminutes($annual_leave_hours); ?> class="input-type"></td>
							</tr>
							<tr>
								<td>Bank Holiday</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_bank_holiday_hours"?>" name="Toll" placeholder="<?php echo seconds_to_hoursminutes($bank_holiday_hours); ?>" class="input-type"></td>
							</tr>
							<tr>
								<td>Toil</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_toil_hours"?>" name="Toll" placeholder="<?php echo seconds_to_hoursminutes($toil_hours); ?>" class="input-type"></td>
							</tr>
							<tr>
								<td>Support</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_support_hours"?>" name="Toll" placeholder="<?php echo seconds_to_hoursminutes($support_hours); ?>" class="input-type"></td>
							</tr>
							<tr>
								<td>TOTAL</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_total_hours"?>" name="Total" data-amount-value="<?php echo $total_hours;?>" placeholder="<?php echo seconds_to_hoursminutes($total_hours); ?>" class="input-type total_hours"></td>
							</tr>
							<?php
							...
							<tr>
								<td>OVERTIME</td>
								<td ><input type="text" id = "<?php echo $staff_obj->employee_number ."_overtime_hours"?>" name="Overtime" placeholder="<?php echo seconds_to_hoursminutes($overtime_hours); ?>" class="input-type"></td>
							</tr>
						</table>
					</div>
		...
		{	
			echo '<tr style="padding: 0;"><td colspan="9" style="padding: 0;padding: 0;font-size: 22px;height: 100px;vertical-align: middle;color: red;">No Record Found.</td></tr>';
		}
        ?>	
		
		</table>
		<div id="total_weekly_hours_value" data-week-total-hours="<?php echo seconds_to_hoursminutes($total_weekly_hours); ?>"></div>
		</div>
		</section>
		</div>
	<!--	
...
<!--This is the Footer section of the website -->
	...
	<script src="js/manage_forms.js"></script>	
	<script>
	$("#weekly_hours_container").html('<?php echo $_SESSION['login_department_name']; ?> Total Weekly Hours : '+$("#total_weekly_hours_value").attr('data-week-total-hours'));
