...
##### get all shift count of staff start ######
	...
	{
		echo '<script>window.location.href = "total_shift_staff_month_query.php" </script>';
		exit;
	...
	$pdf_html = '';
	$pdf_html  .= '<h1 style="text-align:center">Total Shift Of Staff Month Report ('.$_SESSION['login_department_name'].')</h1><table border="1" width="100%" cellpadding="20" cellspacing="0">
	<thead>
		<tr>
